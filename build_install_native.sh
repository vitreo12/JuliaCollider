...
rsync -r --links --update "$JULIA_PATH/lib" ./julia/Julia #copy julia lib from JULIA_PATH to the new Julia folder, maybe also copy include?
rsync -r --links --update ../src/JuliaDSP ./julia/Julia   #copy JuliaDSP/.jl stuff..
